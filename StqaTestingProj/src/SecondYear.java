...
public class SecondYear extends JFrame {
	...
	private JTextField textFieldFSSub9;
	...
	public SecondYear() {
		...
		JLabel lblFSSub1 = new JLabel("210241");
		...
		JLabel lblFSSub2 = new JLabel("210242");
		...
		JLabel lblFSSub3 = new JLabel("210243");
		...
		JLabel lblFSSub4 = new JLabel("210244");
		...
		JLabel lblFSSub5 = new JLabel("210245");
		...
		JLabel lblFSSub6 = new JLabel("210246");
		...
		JLabel lblFSSub7 = new JLabel("210247");
		...
		JLabel lblFSSub8 = new JLabel("210248");
		...
		JLabel lblFSSub9 = new JLabel("210249");
		lblFSSub9.setFont(new Font("Tahoma", Font.PLAIN, 32));
		lblFSSub9.setHorizontalAlignment(SwingConstants.CENTER);
		lblFSSub9.setBounds(100, 795, 150, 60);
		contentPane.add(lblFSSub9);
		...
		textFieldFSSub9 = new JTextField();
		textFieldFSSub9.setFont(new Font("Tahoma", Font.PLAIN, 32));
		textFieldFSSub9.setHorizontalAlignment(SwingConstants.CENTER);
		textFieldFSSub9.setBounds(595, 795, 250, 60);
		contentPane.add(textFieldFSSub9);
		textFieldFSSub9.setColumns(10);
		
		JLabel lblSSSub1 = new JLabel("207003");
		...
		JLabel lblSSSub2 = new JLabel("210251");
		...
		JLabel lblSSSub3 = new JLabel("210252");
		...
		JLabel lblSSSub4 = new JLabel("210253");
		...
		JLabel lblSSSub5 = new JLabel("210254");
		...
		JLabel lblSSSub6 = new JLabel("210255");
		...
		JLabel lblSSSub7 = new JLabel("210256");
		...
		JLabel lblSSSub8 = new JLabel("210257");
		...
		btnCalculate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					int FSSub9 = Integer.parseInt(textFieldFSSub9.getText());
					
					arrs1 = new int[]{FSSub1,FSSub2,FSSub3,FSSub4,FSSub5,FSSub6,FSSub7,FSSub8,FSSub9};
				}catch(Exception e) {
					arrs1 = new int[] {0};
					fsem = true;
				}
				...
				try {
					...
					int SSSub8 = Integer.parseInt(textFieldSSSub8.getText());
					
					arrs2 = new int[]{SSSub1,SSSub2,SSSub3,SSSub4,SSSub5,SSSub6,SSSub7,SSSub8};
				}catch(Exception e) {
					arrs2 = new int[] {0};
					ssem = true;
				}
				...
				if(fsem == true && ssem == true) {
					...
					if(arrs1.length==9 && arrs2.length==8) {
						cgpa = cal.SEcalcSGPA(arrs1,arrs2);
					}
					else {
						arrs1 = new int[] {0};
						arrs2 = new int[] {0};
