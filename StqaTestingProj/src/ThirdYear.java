		...
		btnCalculate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					int SSSub9 = Integer.parseInt(textFieldSSSub9.getText());
					
					arrs2 = new int[]{SSSub1,SSSub2,SSSub3,SSSub4,SSSub5,SSSub6,SSSub7,SSSub8,SSSub9};
				}catch(Exception e) {
					arrs2 = new int[] {0};
					ssem = true;	
				}
				...
				if(fsem == true && ssem == true) {
					...
					sgpa1stsem = cal.TEcalcCGPA(arrs1);
					sgpa2ndsem = cal.TEcalcCGPA(arrs2);
					
					if(arrs1.length==8 && arrs2.length==9) {
						cgpa = cal.TEcalcSGPA(arrs1,arrs2);
					}
					else {
						arrs1 = new int[] {0};
						arrs2 = new int[] {0};
